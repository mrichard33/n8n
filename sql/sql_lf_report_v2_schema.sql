...
INSERT INTO lf_report_config (key, value, note) VALUES
  ...
  ('small_denominator_min',   '20',                      'net_issued below this = small sample'),
  ('min_matured_for_table',   '3',                       'agents below this are excluded from tables'),
...
-- Seed with real addresses at deploy time. Any single active approver may decide.
